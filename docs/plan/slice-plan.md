...
| [[M-02\|M-02 Source]] | SCR-053 to SCR-058, SCR-086, SCR-103 | E-13 to E-20 | M-01 | [[SLICE-01]] \| M-16, M-15 |
...
| [[M-16\|M-16 Administration]] | SCR-070 to SCR-079, GAP-SCR-004, GAP-SCR-008, GAP-SCR-009 | E-77 to E-81 | M-01 | [[SLICE-01]] \| every module |
...
honest until the platform work in [[SLICE-01]] to [[SLICE-04]] lands, and those four
...
the Person, Role and ActionAuthority tables that [[SLICE-01]] already needs, and it
...
| 05 | [[SLICE-05\|Empty states, refusals and the clock service]] | SCR-080, SCR-087, SCR-089, SCR-092, SCR-094, SCR-095, SCR-104, and every screen | E-12 | M-01 | 01 | Four different empty messages; one refusal catalogue; every time through one clock service in the organisation's zone, with "as at" stamped on every metric surface | not started |
...
| # | Slice | Screens | Entity | Module | Depends on | Proves | Status |
|---|---|---|---|---|---|---|---|
| 43 | [[SLICE-43\|Settings, read and write]] | SCR-071 to SCR-078 | E-77 to E-80 | M-16 | 01 | Every section is readable by everyone and writable only by the administrator, and every change is maker-checked before it takes effect | not started |
...
```mermaid
flowchart LR
    S00["00 Scaffold"] --> S01["01 Identity, authority, scope"]
    S01 --> S02["02 The one ladder"]
    S01 --> S03["03 Files"]
    S01 --> S04["04 Search"]
    S01 --> S05["05 Empty states, refusals, clock"]
...
Two things this makes visible. **Administration hangs off [[SLICE-01]] alone**, so it
